...
const categoryColors: Record<Category, string> = {
  ...
  japanese: 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400',
  ...
  programming: 'bg-violet-100 text-violet-700 dark:bg-violet-900/30 dark:text-violet-400',
}
